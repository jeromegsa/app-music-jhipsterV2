...
public class CategoryTestSamples {
    ...
    public static Category getCategorySample1() {
        return new Category().id(1L).category_name("category_name1");
    }

    public static Category getCategorySample2() {
        return new Category().id(2L).category_name("category_name2");
    }

    public static Category getCategoryRandomSampleGenerator() {
        return new Category().id(longCount.incrementAndGet()).category_name(UUID.randomUUID().toString());
    }
}
