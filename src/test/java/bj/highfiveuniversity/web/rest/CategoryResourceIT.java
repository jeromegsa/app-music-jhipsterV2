...
import static bj.highfiveuniversity.domain.CategoryAsserts.*;
...
import bj.highfiveuniversity.repository.CategoryRepository;
...
class CategoryResourceIT {
    ...
    public static Category createEntity() {
        return new Category().category_name(DEFAULT_CATEGORY_NAME);
    }
    ...
    public static Category createUpdatedEntity() {
        return new Category().category_name(UPDATED_CATEGORY_NAME);
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.category_name(UPDATED_CATEGORY_NAME);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.category_name(UPDATED_CATEGORY_NAME);
